...
define(['backbone', 'handlebars', 'underscore', 'jquery', 'marionette', 'moment', 'hbs!templates/stream_header_tpl'],

    function(Backbone, Handlebars, _, $, Marionette, moment, streamHeaderTemplate) {
